        ...
        const cartItemsWithImages = await Promise.all(
          updatedCartItems.map(async (item) => {
            try {
              ...
              const backendProduct = response.data.find(
                (p) => p.p_id === item.id
              );

              return {
                ...item,
                name: backendProduct.p_name,
                brand: backendProduct.p_brand,
                description: backendProduct.p_desc,
                stockQuantity: backendProduct.quantity,
                productAvailable: backendProduct.available,
                releaseDate: backendProduct.date,
